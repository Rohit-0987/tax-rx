        ...
        <div class="hk-pg-wrapper">
            <div class="container-xxl">
                ...
                <div class="hk-pg-header pt-7 pb-4">
                    <h1 class="pg-title">Edit Vendor</h1>
                </div>
                <div class="col-lg-10 col-sm-9 col-8">
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="tab_block_1">
                            <form action="{{ url('/EditVendor') }}{{ $VendorDetail[0]->VendorId }}" method="post">
                                @csrf
                                ...
                                <div class="row gx-3">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text"
                                                value="{{ $VendorDetail[0]->VendorName }}" name="VendorName"
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text"
                                                value="{{ $VendorDetail[0]->VendorAddress }}" name="VendorAddress"
                                ...
                                <div class="row gx-3">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text"
                                                value="{{ $VendorDetail[0]->GstNumber }}" name="GstNumber"
                                ...
                                <div class="row gx-3">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="PanNumber"
                                                value="{{ $VendorDetail[0]->PanNumber }}"
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text"
                                                value="{{ $VendorDetail[0]->Email }}" name="Email"
                                ...
                                <div class="row gx-3">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text"
                                                value="{{ $VendorDetail[0]->MobileNumber }}" name="MobileNumber"
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text"
                                                value="{{ $VendorDetail[0]->BankName }}" name="BankName"
                                ...
                                <div class="row gx-3">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text"
                                                value="{{ $VendorDetail[0]->IFSC }}" name="IFSC"
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text"
                                                value="{{ $VendorDetail[0]->BankAccount }}" name="BankAccount"
