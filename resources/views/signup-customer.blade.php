    ...
    Container -->
     ...
     Row -->
      ...
      <div class="col-xl-5 col-lg-6 col-md-5 d-md-block d-none bg-primary-dark-3 bg-opacity-85 position-relative">
       <img class="bg-img" src="added-assets/dist/img/signup-bg.jpg" alt="bg-img">
          ...
          <div class="row gx-3 mt-7">
           <div class="col-lg-6">
            <div class="card card-shadow">
             <img class="card-img-top" src="added-assets/dist/img/slide1.jpg" alt="Card image cap">
             <div class="card-body">
           ...
           <div class="col-lg-6">
            <div class="card card-shadow">
             <img class="card-img-top" src="added-assets/dist/img/slide2.jpg" alt="Card image cap">
             <div class="card-body">
        ...
        <div class="col-xl-7 col-lg-6 col-md-7 col-sm-10 position-relative mx-auto">
            <div class="auth-content flex-column pt-8 pb-md-8 pb-13">
                <div class="text-center mb-7">
                    <a class="navbar-brand me-0" href="index.html">
                        <img class="brand-img d-inline-block tax-rx-img" src="added-assets/dist/img/TaxRx-01.png"
                            alt="brand">
                    </a>
                </div>

                <form class="w-100" method="POST" action="signup-customer-check">
                    @csrf
                    <div class="row">
           ...
           <button class="btn btn-social btn-social-facebook btn-rounded btn-block"><span><span class="icon"><i class="fab fa-facebook"></i></span><span>Sign Up with Facebook</span></span></button> -->
                                ...
                                <div class="form-group col-lg-12">
                                    ...
                                    <div class="input-group password-check">
                                        <span class="input-affix-wrapper affix-wth-text">
                                            <input name="password" class="form-control" placeholder="6+ characters"
                                                value="" type="password">
                                            <a href="#"
                            ...
                            <div class="form-check form-check-sm mb-3">
                                ...
                                <label class="form-check-label text-muted fs-8" for="logged_in">By creating an account
                                    you specify that you have read and agree with our <a href="#">Tearms of
                                        use</a> and <a href="#">Privacy policy</a>. We may keep you inform about
                                    latest updates through our default <a href="#">notification
                                        settings</a></label>
                            </div>
                            <button type="submit" class="btn btn-primary btn-rounded btn-uppercase btn-block">Create
                                account</button>
                            <p class="p-xs mt-2 text-center">Already a member ? <a href="#"><u>Sign In</u></a>
                            </p>
                        </div>
                    </div>
                </form>
